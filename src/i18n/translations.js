export const TRANSLATIONS = {
  ja: {
    ...
    "howto.section.fever.item1": "左右スワイプでペンライトを振ると、ポイントが増加し、推しのレス演出も発生します。",
  ...
  en: {
    ...
    "howto.section.basics.title": "Basics",
    "howto.section.basics.item1": "After starting, check the TARGET COLOR.",
    "howto.section.basics.item2": "Use the left/right buttons to cycle the penlight; match the TARGET COLOR to score points.",
    "howto.section.basics.item3": "Match 3 times within 2 seconds to enter Appeal Time.",
    "howto.section.fever.title": "Appeal Time",
    "howto.section.fever.item1": "Swipe left and right to swing the penlight, earn extra points, and trigger idol reactions.",
    "howto.section.fever.item2": "Appeal Time lasts 10 seconds and pauses the main timer.",
    "howto.section.fever.item3": "When it ends, the game automatically returns to normal play.",
    "howto.section.scoring.title": "Normal Mode Scoring (per match)",
    "howto.section.scoring.easyLabel": "EASY",
  ...
  ko: {
    ...
    "howto.section.basics.item2": "좌우 버튼으로 펜라이트 색을 바꿔 TARGET COLOR 와 일치시키면 점수를 획득합니다.",
    "howto.section.basics.item3": "2초 안에 3회 성공하면 ‘어필 타임’에 진입합니다.",
    "howto.section.fever.title": "어필 타임",
    "howto.section.fever.item1": "좌우 스와이프로 펜라이트를 흔들면 포인트가 늘고, 오시의 리액션 연출이 발생합니다.",
    "howto.section.fever.item2": "어필 타임은 10초 동안 지속되며 그동안 메인 타이머는 멈춥니다.",
    "howto.section.fever.item3": "종료 후에는 자동으로 일반 모드로 돌아갑니다.",
    "howto.section.scoring.title": "일반 모드 점수 (한 번 성공 시)",
    "howto.section.scoring.easyLabel": "EASY",
    "howto.section.scoring.easyValue": "+6점",
    "howto.section.scoring.normalLabel": "NORMAL",
    "howto.section.scoring.normalValue": "+10점",
    "howto.section.scoring.hardLabel": "HARD",
    "howto.section.scoring.hardValue": "+13점",
